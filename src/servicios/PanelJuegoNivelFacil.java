...
public class PanelJuegoNivelFacil extends JPanel implements ActionListener {
    ...
    private void inicializarLadrillos() {
        ...
        int ladrilloAncho = 80; // Ancho fijo para los ladrillos
        int ladrilloAlto = 20;  // Alto fijo para los ladrillos
        int espacioEntreX = 10; // Espacio horizontal entre ladrillos
        int espacioEntreY = 10; // Espacio vertical entre ladrillos
        int margenSuperior = 50; // Margen desde la parte superior
